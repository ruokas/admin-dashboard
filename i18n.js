export const Tlt = {
  ...
  chartScale: 'Mastelis',
  chartHint:
    'Įveskite iframe nuorodą arba pilną įterpimo kodą. Kortelės plotis ir aukštis prisitaiko automatiškai, mastelį reguliuokite slankikliu.',
  chartPreview: 'Gyva peržiūra',
  chartPreviewScale: 'Mastelis',
  chartPreviewWidth: 'Rodymo plotis',
  chartPreviewHeight: 'Rodymo aukštis',
  ...
  chartDragHint: 'Mastelį keiskite slankikliu aukščiau – kortelės dydis prisitaikys automatiškai.',
